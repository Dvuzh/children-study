  ...
  <div class="all-tasks">
    <div class="tasks-block">
      <div class="task-block">
        <div class="task">
          <div class="task-title">Заполни недостающие элементы</div>
          <div class="task-body">
            <div class="svg">
              <svg
                id="tutorial"
  ...
  methods: {
    ...
    generateThings(count) {
      for (let i = 0; i < count; i++) {
        ...
        let rect = this.pottis.shape("rect", {
          x: this.curentRect.x,
          y: this.curentRect.y,
          width: 50,
          height: 40,
        ...
        let circle = this.pottis.shape("circle", {
          cx: this.curentCircle.x,
          cy: this.curentCircle.y,
          r: 20,
          fill: "blue"
        });
        ...
        let rect2 = this.pottis.shape("rect", {
          x: 10,
          y: 10,
          width: 50,
          height: 40,
        ...
        let circle2 = this.pottis.shape("circle", {
          cx: 70,
          cy: 10,
          r: 20,
          fill: "yellow"
    ...
    wheelDropped(receiver, dropped) {
      ...
      this.pottis.remove(receiver)
      this.pottis.remove(dropped)
      this.pottis.removeDrag(dropped);
      this.countObj --;
      if(this.countObj == 0){
        this.isFinished = true;
        alert(
          "Все недостающие элементы заполнены. Нажмите завершить, чтобы закончить задание."
        );
      }
    },
    ...
    ...mapMutations(["setOpenTask", "setSubTask", "setFinishedTaski"])
  }
};
</script>
