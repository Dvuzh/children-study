  ...
  <div class="all-tasks">
    <div class="tasks-block">
      <div class="task-block">
        <div class="task">
          <div class="task-title">Покрась в желтый цвет</div>
          <div class="task-body">
            <div class="svg">
            ...
            <div class="tools">
              <div class="color" v-for="(color, i) in colors" :style="{background: color}" v-bind:key="i" @click="selectColor(color)"></div>
            </div>
  ...
  methods:{
      ...
      generateThings(count) {
        for(let i = 0; i < count; i++) {
          this.draw("Fish" + (i + 1), 50 + 150 * i, 100 + (this.randomInt(-50, 50)), 0.1);
        }
      },
